...
def minimaxab_decision(tour):    
    ...
    possibles_minimaxab_choices = { tuple(action):minimaxab(Game(action,-tour.player), -inf, +inf) for action in actions} # all possibles tours with their corresponding minimax values
