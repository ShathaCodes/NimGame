...
def minimax_decision(tour):    
    ...
    possibles_minimax_choices = { tuple(action):minimax(Game(action,-tour.player)) for action in actions} # all possibles tours with their corresponding minimax values
